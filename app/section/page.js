...
const Section = () => {
  ...
  useEffect(() => {
    const fetchSections = async () => {
      try {
        const response = await axios.get("https://absback.vercel.app/api/section");
  ...
  const handleEditSubmit = async () => {
    ...
    try {
      ...
      await axios.patch(
        `https://absback.vercel.app/api/section/${sectionToEdit._id}`,
        {
  ...
  const handleDeleteConfirmed = async () => {
    ...
    try {
      await axios.delete(
        `https://absback.vercel.app/api/section/${sectionToDelete._id}`
      );
      ...
      const sectionsResponse = await axios.get(
        "https://absback.vercel.app/api/section"
      );
  ...
  const handleAddSubmit = async () => {
    try {
      ...
      const response = await axios.post(
        "https://absback.vercel.app/api/section/create",
        formData,
        {
          headers: {
