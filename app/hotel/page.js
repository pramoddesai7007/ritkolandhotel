...
const CreateHotelForm = () => {
  ...
  const fetchHotels = async () => {
    try {
      const response = await axios.get('https://absback.vercel.app/api/hotel/get-all');
  ...
  const handleEdit = async (hotelId) => {
    try {
      const response = await axios.get(`https://absback.vercel.app/api/hotel/get/${hotelId}`);
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.patch(`https://absback.vercel.app/api/hotel/edit/${editFormData._id}`, formDataForUpload);
  ...
  const handleDelete = async (hotelId) => {
    try {
      await axios.delete(`https://absback.vercel.app/api/hotel/delete/${hotelId}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://absback.vercel.app/api/hotel/create', formDataForUpload);
